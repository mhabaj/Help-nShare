...
<div class="profile">
	...
	<div class="roundedImage">
	 ...
	 <div class="corps2">
	 		<button><a href="poster.php">Poster un cours</a></button>

	<h2>Mathématiques</h2>
	<p>Il y a actuellement 1 disponible(s).</p>
	<p><div id="testcours"><b>Chapitre</B> : Suites Numériques | <b>Niveau</B> : Terminale S | <a href="upload/suites.pdf">Le cours ici !</a></div></p>
     </Div>
